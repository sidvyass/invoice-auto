...
class TicketInvoiceTests(unittest.TestCase):
    ...
    def test_sample_total_and_pdf(self):
        ...
        self.assertEqual(totals.net_amount, Decimal("69707.00"))
    ...
    def test_riya_pnr_and_seat_components(self):
        ...
        self.assertEqual(calculate_totals(ticket).net_amount, Decimal("70207.00"))
    ...
    def test_explicit_seat_gross_takes_precedence(self):
        ...
        self.assertEqual(calculate_totals(self.ticket()).seat_amount, Decimal("560.00"))
    ...
    def test_long_remark_rejected(self):
        self.data["remark"] = "long remark " * 30
        ticket = self.ticket()
    ...
    def test_prompt_collects_one_ticket(self):
        responses = iter([
            ...
            "68222.00", "1485.00", "", "", "", "IMPERIAL FRAGRANCES", "", "",
        ])
        ticket = prompt_ticket(lambda _: next(responses))
        self.assertEqual(calculate_totals(ticket).net_amount, Decimal("69707.00"))
